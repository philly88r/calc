...
OUTPUT_SQL_FILE = Path(r"C:\Users\info\crmcalc\src\scripts\complete_import_with_id.sql")
    ...
    try:
        ...
        with open(OUTPUT_SQL_FILE, 'w', encoding='utf-8') as sql_file:
            ...
            for batch_num in range(batch_count):
                ...
                sql_file.write("    uuid, sku, name, product_category,\n")
